...
function load_image(debug)
{
  ...
  {
    canvas_buf.width = background.width + POINT_BAR_WITDTH;
    canvas_buf.height = background.height;
    canvas_context.lineWidth = 10;
    canvas_context.strokeRect(0, 0, canvas_buf.width, canvas_buf.height);
    
    canvas_context.drawImage(background,0,0);  
    canvas.draw_circle(100);
    canvas.draw_circle(300);
    canvas.draw_circle(500);
    canvas.draw_circle(700);
  }
}
